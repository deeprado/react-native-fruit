...
class ItemDetail extends Component {
  ...
  updateCartScreen(value) {
    ...
    if (this.props.rootStore.CartStore)
      index = this.props.rootStore.CartStore.allDatas.data.findIndex(
        (e) => e.name === name,
      );
    // 不存在
    if (index == -1) {
      ...
      this.props.rootStore.CartStore.allDatas.data[
        length - 1
  ...
  goCartPage() {
    ...
    this.props.navigation.navigate('Cart', {
      headerStyle: {alignSelf: 'auto', fontSize: 15, color: theme.fontColor},
    });
  }
      ...
      <ScrollView
        ...
        <View style={styles.topWrapper}>
          ...
          <View style={styles.chooseLine}>
            ...
            <TouchableOpacity
              style={styles.button}
              onPress={this.reduceNum.bind(this)}>
              <Text style={styles.buttonText}>-</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.button, {paddingLeft: 24, paddingRight: 10}]}
              onPress={() =>
                this.addCart(this.props.navigation.state.params.value)
              }>
