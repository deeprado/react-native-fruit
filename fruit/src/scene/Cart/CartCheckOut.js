...
class CheckOut extends Component {
  ...
  _allSelect() {
    this.props.mobx.CartStore.allDatas.isAllSelected = !this.props.mobx
      .CartStore.allDatas.isAllSelected;
      ...
      <View style={styles.container}>
        ...
        <View style={styles.right}>
          ...
          <Text style={{fontSize: 22, color: '#000'}}>
            ￥ {this.props.mobx.CartStore.totalMoney}
          </Text>
        </View>
